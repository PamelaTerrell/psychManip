...
const Narcissism = () => {
  return (
    <div className="topic-page">
      ...
      <p>
        This page explores the psychological roots, behavioral patterns, and social consequences
      ...
      <section>
        ...
        <p>
          Unlike grandiose narcissists, vulnerable narcissists are more introverted and sensitive to criticism. They may
          appear shy or insecure but harbor feelings of entitlement and resentment. Their narcissism is often masked by
          self-doubt and emotional instability, leading to passive-aggressive behavior or social withdrawal.
        </p>
